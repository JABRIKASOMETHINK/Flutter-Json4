      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            labelColor: Color.fromARGB(255, 235, 84, 84),
            unselectedLabelColor: Colors.grey,
            indicatorColor: Color.fromARGB(255, 235, 84, 84),
            indicatorWeight: 4.0,
          ),
          backgroundColor: Color.fromARGB(255, 189, 248, 187), // Soft galaxy purple for the app bar
        ),
        body: TabBarView(
          children: [
            BerandaTab(),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 189, 248, 187), // Soft pink for the bubble background
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 209, 209, 203), // Matching soft galaxy purple for the app bar
      ),
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  leading: CircleAvatar(
                    backgroundColor: Color.fromARGB(255, 189, 248, 187),
      ...
      child: Column(
        ...
        children: [
          Center(
            child: CircleAvatar(
              radius: 60,
              backgroundImage: AssetImage('profil.jpg'), // Ensure the path is correct
            ),
          ),
          SizedBox(height: 20),
          Center(
            child: Text(
              'Brifky Akmal',
              style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 189, 248, 187)),
            ),
          ),
          SizedBox(height: 10),
          Center(
          ...
          Text(
            'Biodata',
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 189, 248, 187)),
          ),
          Divider(),
          ListTile(
            leading: Icon(Icons.person, color: Color.fromARGB(255, 189, 248, 187)),
            title: Text('Nama Lengkap'),
            subtitle: Text('Brifky Akmal'),
          ),
          ListTile(
            leading: Icon(Icons.cake, color: Color.fromARGB(255, 189, 248, 187)),
            title: Text('Tanggal Lahir'),
            subtitle: Text('11 Juni 2007'),
          )
        ],
      ),
    );
